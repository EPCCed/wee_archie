...
implicit none
    ...
    integer, parameter :: nx_global = 500
    integer, parameter :: ny_global = 500
    ...
    real :: r0 = 1E1 !Reynolds number (bigger = less viscous and hence less diffusion)
    real :: vortcoeff = 0.5 !vorticity generated by wings
